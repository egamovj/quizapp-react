  ...
  css: [
    {
      ...
      answer: "Italic qiladi",
    },
    {
      id: 2,
      question: "Qaysi qiymat qalin matn beradi?",
    ...
    },
    {
      ...
      answer: "O‘z joyiga nisbatan",
    },
    {
      id: 8,
      question: "Qaysi position ekran bilan bog‘liq?",
      options: ["absolute", "relative", "fixed", "static"],
      answer: "fixed",
    },
    {
      id: 9,
      question: "Flex yoqish uchun qaysi yozuv ishlatiladi?",
    ...
    },
    {
      ...
      options: ["Vertikal", "Gorizontal", "Rang", "Border"],
      answer: "Gorizontal",
    },
    {
      id: 11,
      question: "Grid yoqish uchun qaysi yozuv ishlatiladi?",
    ...
    },
    {
      ...
      options: ["Rang", "Masofa", "O‘lcham", "Border"],
      answer: "Masofa",
    },
    {
      id: 13,
    ...
    },
    {
      ...
      options: ["Animatsiya", "Responsive", "Rang", "Border"],
      answer: "Responsive",
    },
    {
      id: 16,
      question: "font-weight: 700 nimani bildiradi?",
      options: ["Light", "Bold", "Italic", "Thin"],
      answer: "Bold",
    },
    {
      id: 17,
    ...
    },
    {
      ...
      options: [
        "Takrorlaydi",
        "Bir marta ko‘rsatadi",
        "O‘chiradi",
        "Kattalashtiradi",
      ],
      answer: "Bir marta ko‘rsatadi",
    },
    {
      id: 19,
      ...
      answer: "To‘liq yopadi",
    },
    {
      id: 20,
      question: "position: absolute nimaga nisbatan ishlaydi?",
      options: ["O‘z joyiga", "Parentga", "Ekranga", "Ishlamaydi"],
      answer: "Parentga",
    },
    {
      id: 21,
      question: "z-index nima qiladi?",
      options: ["Rang", "Qatlam", "O‘lcham", "Margin"],
      answer: "Qatlam",
    },
    {
      id: 22,
      question: "align-items: center nima qiladi?",
      options: ["Gorizontal", "Vertikal markaz", "O‘ngga", "Chapga"],
      answer: "Vertikal markaz",
    },
    {
      id: 23,
      question: "flex-direction: column nimani bildiradi?",
      options: ["Qator", "Ustun", "Grid", "Block"],
      answer: "Ustun",
    },
    {
      id: 24,
      question: "Griddagi 1fr nimani bildiradi?",
      options: ["Pixel", "Foiz", "Fraction", "Auto"],
      answer: "Fraction",
    },
    {
      id: 25,
      question: "grid-template-rows nima uchun?",
      options: ["Ustunlar", "Qatorlar", "Rang", "Border"],
      answer: "Qatorlar",
    },
    {
      id: 26,
      question: "CSS variable qayerda e’lon qilinadi?",
      options: ["body", ":root", "html", "div"],
      answer: ":root",
    },
    {
      id: 27,
      question: "var(--main-color, red) nimani bildiradi?",
      options: ["Xato", "Default qiymat", "Rang o‘chiradi", "Gradient"],
      answer: "Default qiymat",
    },
    {
      id: 28,
      question: "max-width: 768px nimani bildiradi?",
      options: ["768 dan katta", "768 dan kichik", "Faqat 768", "Hammasi"],
      answer: "768 dan kichik",
    },
    {
      id: 29,
    ...
    },
    {
      ...
      options: ["body", "html", "viewport", "div"],
      answer: "viewport",
    },
    {
      id: 32,
      question: "Flex’da to‘liq markazlash uchun nima kerak?",
      options: ["justify", "align", "justify + align", "gap"],
      answer: "justify + align",
    },
    {
      id: 33,
      question: "flex-wrap: wrap nima qiladi?",
      options: ["Siqadi", "Qatorga o‘tkazadi", "O‘chiradi", "Markazlaydi"],
      answer: "Qatorga o‘tkazadi",
    },
    {
      id: 34,
    ...
    {
      id: 35,
      question: "minmax(200px, 1fr) nimani bildiradi?",
      options: ["Faqat 200px", "200px dan 1fr gacha", "Faqat 1fr", "Xato"],
      answer: "200px dan 1fr gacha",
    },
    {
      id: 36,
      question: "CSS variable scope nimaga bog‘liq?",
      options: ["JS", "DOM tree", "Browser", "Server"],
      answer: "DOM tree",
    },
    {
      id: 37,
    ...
    {
      id: 38,
      question: "Media query priority nimaga bog‘liq?",
      options: ["Tartibga", "Rangga", "Fontga", "Width ga"],
      answer: "Tartibga",
    },
    {
      id: 39,
      question: "position: fixed + top: 0 nima qiladi?",
      options: ["Pastga tushadi", "Tepada qoladi", "Yo‘qoladi", "Markaz"],
      answer: "Tepada qoladi",
    },
    {
      id: 40,
      ...
      options: [
        "Scroll qo‘shadi",
        "Ortiqcha qismini yashiradi",
        "Kattalashtiradi",
        "Rang beradi",
      ],
      answer: "Ortiqcha qismini yashiradi",
    },
  ],
  js: [
    {
